	...
	<div class="contain-to-grid sticky">	
		<nav class="top-bar" data-topbar>
			...
			<ul class="right">
				...
				<li class="active"><a href="businesscontacts.php<?php if (isset($_SESSION['version'])) {echo("?version=full");}?>" <?php if(curPageName() =="businesscontacts.php") {echo('id="current_page"');}?>>Business Contacts</a></li>
